...
if __name__=="__main__":
    ...
    parser.add_argument('--opt', type=str, default=f'{code_path}/option/Sultimulate1Dist.yaml', help='Path to the configuration file')
...
# load the phase of the fiber distortion
    ...
    pred_pha = t.train_1dist()



    tSam = Trainer(para,sam_datas,f"{result_folder}/sam")
    sam_pred_pha = tSam.train_1dist()    
