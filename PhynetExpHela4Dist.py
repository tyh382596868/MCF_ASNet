...
if __name__=="__main__":
    ...
    parser.add_argument('--opt', type=str, default=f'/ailab/user/tangyuhang/LenslessFiberEndomicroscopicPhaseImaging/ASNet/option/phynet/phynetExpHela4Dist.yaml', help='Path to the configuration file')
